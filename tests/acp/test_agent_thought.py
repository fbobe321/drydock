...
def acp_agent_loop_with_reasoning(
    ...
    config = build_test_drydock_config(active_model="devstral-latest")
    ...
    patch("drydock.acp.acp_agent_loop.AgentLoop", side_effect=PatchedAgentLoop).start()
...
class TestACPAgentThought:
    ...
    async def test_prompt_with_reasoning_emits_agent_thought_chunk(
        self, acp_agent_loop_with_reasoning: DrydockAcpAgentLoop
    ) -> None:
