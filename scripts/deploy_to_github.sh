...
cd "$DRYDOCK_SRC"
if ! python3 -m pip install -q "pytest>=9.0" 2>/dev/null; python3 -m pytest tests/test_drydock_regression.py tests/test_drydock_tasks.py tests/test_loop_detection.py tests/test_agent_tasks.py tests/test_integration.py tests/test_user_issues.py tests/test_real_issues.py \
