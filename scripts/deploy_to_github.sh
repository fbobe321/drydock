...
if ! $PYTHON -m pytest tests/test_drydock_regression.py tests/test_drydock_tasks.py tests/test_loop_detection.py tests/test_curiosity.py tests/test_math_tool.py tests/test_count_tool.py tests/test_memory_tool.py tests/test_verify_tool.py tests/test_agent_tasks.py tests/test_integration.py tests/test_user_issues.py tests/test_real_issues.py \
